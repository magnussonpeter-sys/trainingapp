...
export const uiButtonClasses = {
  ...
  ghost:
    "min-h-11 rounded-2xl px-3 py-2 text-sm font-medium text-slate-700 transition hover:bg-slate-100 active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-60",
